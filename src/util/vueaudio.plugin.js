...
//   data() {
//     return {
//       file: 'http://www.w3school.com.cn/i/horse.ogg',
//       isMuted: false,
//       loaded: false,
//       playing: false,
//       paused: false,
...
//       let percentage = parseInt((currTime / this.audio.duration) * 100)
...
export default {
  ...
  data () {
    return {
      ...
      file:'https://shershen08.github.io/vue-plugins-demo-static/dist/sample.mp3',
      autoPlay:false
    }
  },
  methods: {
