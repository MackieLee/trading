        ...
        <form class="login-form">
          ...
          <div class="remember">
            <span @click="toggleChecked">
              <input type="checkbox" name="remember"/><i :class="[ { checked: checked },{ unchecked: !checked },'iblock' ]"></i><label for="remember">下次自动登录</label>
            </span>
  ...
  .content{
    ...
    .login-form {
      ...
      .others {
        ...
        .qq{
          background-position: -102.5px -81px;
          &:hover{
            background-position: -139px -149px;
          }
        }
        .alipay{
          background-position: -102.5px -122.5px;
          &:hover{
