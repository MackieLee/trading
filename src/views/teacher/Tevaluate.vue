...
@import '../../assets/style/base.scss';
 .my_order_r {
  height: 900px;width: 811px; margin-left: 55px;
  margin: 0 auto;
  background-color: $white;
  .p02{height: 50px;
    width: 100%;
    border-bottom: 1px solid #ddd;
    .cur{border-bottom: 1px solid #e7151b; color: #e7151b;}
    span{
    height: 50px;
    width: 110px;
    font-size: 14px;
...
.sum_of_class{background-color: #468ee3; border: none;height: 40px;
    line-height: 40px;font-size: 16px; text-align: center;color: #fff;}
.div01{ border: 1px solid #ddd; margin: 20px 0; 
padding:10px 10px; overflow:hidden;
 i{height: 30px;}
ul{ border-bottom: 1px dashed #ddd; margin-bottom: 10px;}
li{margin: 10px 0;}
li h4,li p,li span{font-size: 14px; float: left; }  
h4{width: 130px; padding-left: 5px;}
 p{position:relative; height:16px;width:550px;margin: 0 10px;
 margin-top: 3px;background: #ddd; border-radius: 10px;}
.p_i{background: #46dde3; height:100%; border-radius:10px;
 width:90%;position: absolute;top: 0px;left: 0px;}
 span{width:70px;text-align: center;}
} 
.div02{
	margin: 20px 0;
	.p1{
		border-left: 1px solid #ddd; overflow: hidden;
		span{display: block; border-right: 1px solid #ddd;border-bottom: 1px solid #ddd;
		width:140px; text-align: center; line-height: 40px;height: 40px; float: left;}
		.span1{width:104px;}
	}
	h3{background-color: #468ee3; border: none;height: 40px;padding-left: 15px;
