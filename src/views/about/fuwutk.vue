...
（1）遵守有关法律规定，遵从本网站合法服务程序。<br>
   		   ...
   		   <P>
   		   <div><h3>会员承担的责任</h3></div>
	    		 <font>1、</font>九鼎财税所有会员需自备上网所需要的设备，自行承担上网产生的各项费用。使用自己的电脑能够顺利地接入国际互联网，并能访问本网站主页。<br>
