      ...
      <table>
        <tr>
          ...
          <td width="550">互联网账号存在风险，建议您定期修改密码以保护账号安全。</td>          
           <router-link width="100" class="manager" :to="{path:'InitpwdModal'}" tag="td">
           	修改密码</router-link>
        </tr>
        <tr>
          <th><i class="stay"></i>邮箱验证</th>
          <td>验证后，可用于快速找回登录密码，接收账户余额变动提醒。</td>
          <router-link width="100" class="manager" :to="{path:'InitpwdModal1'}" tag="td">
           	绑定邮箱</router-link>
        </tr>
        <tr>
          ...
          <td>您验证的手机:<span style="font-weight:bold;margin: 0 10px;">177*****234</span>
          	若已丢失或停用，请立即更换。</td>
          <router-link width="100" class="manager" :to="{path:'InitpwdModal2'}" tag="td">
           	修改</router-link>
        </tr>
      </table>
